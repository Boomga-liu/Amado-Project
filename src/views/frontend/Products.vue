        ...
        <div class="shop-sidebar h-100">
            ...
            <div class="brands-checkbox">
              ...
              <div class="form-check">
                <input
                  ...
                  id="Ikea"
                />
                <label class="form-check-label" for="Ikea">
                  Ikea
                </label>
              </div>
              <div class="form-check">
                <input
                  ...
                  id="Furniture Inc"
                />
                <label class="form-check-label" for="Furniture Inc">
                  Furniture Inc
                </label>
              </div>
              <div class="form-check">
                <input
                  ...
                  id="The factory"
                />
                <label class="form-check-label" for="The factory">
                  The factory
                </label>
              </div>
              <div class="form-check">
                <input
                  ...
                  id="Artdeco"
                />
                <label class="form-check-label" for="Artdeco">
                  Artdeco
                </label>
              </div>
            </div>
          ...
          <div class="shop-color">
            ...
            <ul class="list-unstyled d-flex flex-wrap">
              ...
              <li><a href="#" class="dark-orange"></a></li>
              ...
              <div class="card">
                <a href="#">
                  ...
                  <div class="btn-bg" @click.prevent="getProductId(item.id)">
                    <button class="btn btn-outline-primary btn-lg btn-custom">
                      More
                    </button>
                  </div>
                </a>
...
export default {
  ...
  computed: {
    ...
    filterPage() {
      const vm = this;
      const data_length = vm.filterData.length;
      const page_size = vm.pagination.page_size;
      vm.pagination.total_pages = Math.ceil(data_length / page_size);
      const now_page = vm.pagination.current_page;
      if (now_page > 1) {
        vm.pagination.has_pre = true;
      } else {
        vm.pagination.has_pre = false;
      }
      if (now_page < vm.pagination.total_pages) {
      ...
      return vm.filterData.filter((item, index) => {
        return (
          index < now_page * page_size && index >= (now_page - 1) * page_size
